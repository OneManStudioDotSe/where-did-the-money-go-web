...
const projectPhases: Phase[] = [
  ...
  },
  {
    ...
    steps: [
      { name: '14 default categories with 55+ subcategories', completed: true },
      { name: '190+ Swedish merchant pattern mappings', completed: true },
      ...
      { name: 'Batch apply category to similar transactions', completed: true },
    ],
  },
  {
    id: 'phase4',
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Subscription detection algorithm', completed: true },
      { name: 'Subscription confirmation dialog with type selection', completed: true },
      { name: 'Subscription management panel (list & grid views)', completed: true },
      { name: 'Recurring expense vs subscription differentiation', completed: true },
    ],
  },
  {
    id: 'phase7',
    ...
    steps: [
      ...
      { name: 'Custom month start day (salary-aligned periods)', completed: true },
      { name: 'Settings panel (date format, icon set)', completed: true },
      { name: 'Export to CSV/JSON with options', completed: true },
      { name: 'Custom subcategory creation UI', completed: true },
    ],
  },
  {
    id: 'phase8',
    ...
    steps: [
      { name: '4 icon sets (Emoji, Icons8 3D, Lucide, OpenMoji)', completed: true },
  ...
  {
    id: 'phase9',
    name: 'Animations & UX Polish',
    icon: '✨',
    status: 'completed',
    progress: 100,
    description: 'Subtle animations and accessibility improvements',
    steps: [
      { name: 'Card hover lift and shadow animations', completed: true },
      { name: 'Button press effects', completed: true },
      { name: 'Tab content fade/slide transitions', completed: true },
      { name: 'Modal backdrop and slide-up animations', completed: true },
      { name: 'Transaction list pagination with configurable page size', completed: true },
      { name: 'Focus trap and ARIA attributes for all modals', completed: true },
      { name: 'Keyboard navigation (Tab cycling, Escape to close)', completed: true },
      { name: 'Responsive carousel layout (mobile stacked)', completed: true },
    ],
  },
  {
    id: 'phase10',
    ...
    steps: [
      { name: 'BYOK AI integration (OpenAI, Anthropic, Gemini)', completed: true },
      { name: 'Spending pattern analysis prompts', completed: true },
      { name: 'Dedicated Insights tab for quick access', completed: true },
      { name: 'AI provider selection in Settings', completed: true },
    ],
  },
];
