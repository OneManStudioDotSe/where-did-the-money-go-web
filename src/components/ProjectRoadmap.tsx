...
const projectPhases: Phase[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Manual category re-assignment UI', completed: false },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Sort controls (date, amount, category)', completed: false },
    ],
  },
  {
    id: 'phase5',
    ...
    steps: [
      { name: 'Chart library integration', completed: false },
      { name: 'Category breakdown pie/bar chart', completed: false },
      { name: 'Monthly spending trend line chart', completed: false },
      { name: 'Interactive chart filtering', completed: false },
    ],
  },
  {
    id: 'phase6',
    ...
    steps: [
      ...
      { name: 'Time-based grouping (day, week, month, quarter)', completed: false },
      { name: 'Category totals and summaries', completed: false },
      { name: 'Spending comparisons (this vs last month)', completed: false },
    ],
  },
  {
    id: 'phase7',
    ...
    steps: [
      ...
      { name: 'Settings panel (date format, currency)', completed: false },
