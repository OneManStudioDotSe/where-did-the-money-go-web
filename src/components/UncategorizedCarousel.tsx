    ...
    >
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                  ...
                  {currentTransactions.map((transaction) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left border-b border-gray-100 dark:border-slate-700 transition-colors ${
                          isSelected
                ...
                {selectedTransaction ? (
                  <>
                    ...
                    <div className="px-4 py-3 bg-gray-50 dark:bg-slate-700/50 border-b border-gray-200 dark:border-slate-700">
                      ...
                      {pendingCategory && (
                        <div className="mt-3 flex items-center gap-2 p-2 bg-primary-50 dark:bg-primary-900/30 rounded-lg">
                          <span
                    ...
                    {/* Action Buttons */}
                    <div className="px-4 py-3 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/50 flex items-center justify-between">
                      <button
                        onClick={handleSkip}
                  ...
                  <div className="flex-1 flex items-center justify-center text-center p-6">
                    <div>
                      <svg
                        className="w-12 h-12 mx-auto text-gray-300 dark:text-slate-600 mb-3"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
          ...
          {/* Footer */}
          {uncategorizedTransactions.length > 0 && (
            <div className="px-6 py-3 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/50 flex items-center justify-between">
              <p className="text-sm text-gray-500 dark:text-gray-400">
